...
public class ProjectInfoSceneController implements ControlledScreen {
    ...
    private void refreshScene() throws FileNotFoundException {
        clearLabels();
        clearTextViews();
        FileInputStream input = new FileInputStream("src/ui/resources.resources.resources.resources.images.images/blankImage.jpg");
...
//        myController.setScreen(Main.screen4ID);
    ...
    public void refreshMapImage(ActionEvent actionEvent) {
        try {
            ...
            FileInputStream input = new FileInputStream("src/ui/resources.resources.resources.resources.images.images/map_" + pNumber.getText() + ".jpg");
            Image img = new Image(input);
            pMap.setImage(img);
